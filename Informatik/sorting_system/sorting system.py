...
# compare the first two numbers if they in order leave them as they are, otherwise swap them. repeat this process until there are no swaps: for 5 nums (4+3+2+1) 10 comparisons
